...
async def creator(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("[Cʀᴀᴄᴋᴇʀ™♠️](https://t.me/Cracker_IN/)")

@register(outgoing=True, pattern="^.readme$")
async def reedme(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("You might want to have a look at the [README.md](https://github.com/Cracker-IN/Userbot-1/blob/master/README.md) file.")
...
async def repo_is_here(wannasee):
    ...
    if not wannasee.text[0].isalpha() and wannasee.text[0] not in ("/", "#", "@", "!"):
        await wannasee.edit("Click [here](https://github.com/Cracker-IN/Userbot-1) to open this lit af repo.")
